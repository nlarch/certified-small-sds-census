...
1. a signed `(32,20,4)` difference set exists in every noncyclic abelian group
   of order 32 and not in `C32`;
2. no signed `(36,29,4)` difference set exists in `C2 x C18`, `C3 x C12`, or
   `C6 x C6`. Together with the cyclic result already in the repository, this
   closes the abelian order-36 parameter set.
...
full disclosure are included in the package.
